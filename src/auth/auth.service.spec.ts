...
describe('Auth Service', () => {
  ...
  it.todo(
    'should return null if user validation fails with incorrect email or password',
  );
  it.todo(
    'should throw InternalServerErrorException if user validation encounters an error',
  );
  ...
  it.todo(
    'should throw InternalServerErrorException if Google login fails to create user',
  );
  ...
  it.todo(
    'should throw InternalServerErrorException if reset token generation fails',
  );

  it.todo('should verify a valid reset token and return userId');
  it.todo(
    'should throw UnauthorizedException if reset token is invalid or expired',
  );

  it.todo('should reset user password if reset token is valid');
  it.todo(
    'should throw UnauthorizedException if reset token for password reset is invalid',
  );
});
