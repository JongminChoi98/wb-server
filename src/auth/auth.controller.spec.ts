...
import { mockAuthService, mockJwtService, mockMailService, mockUserService } from 'src/utils/test-mocks';
...
describe('AuthController', () => {
  ...
  it.todo('should logout a user and clear access and refresh tokens from cookies');

  it.todo('should initiate Google login process');

  it.todo('should handle Google login redirect and set access and refresh tokens in cookies');
  it.todo('should throw InternalServerErrorException if Google login redirect fails');
  ...
  it.todo('should throw NotFoundException if email is not found during password reset request');
  it.todo('should throw InternalServerErrorException if password reset request processing fails');

  it.todo('should reset password with a valid reset token and new password');
  it.todo('should throw BadRequestException if reset token or new password is missing');
